...
describe("Test Battleship placement and boundaries on a 10x10 Board", () => {
	...
	describe("Horizontal Battleship", () => {
		...
		it("Test set ship orientation to Horizontal", () => {
			const battleship = new Ship2("battle cuiser", 5, Direction.Vertical);
		...
		it("Test ship cell consumption - within boundary", () => {
			...
			const battleship = new Ship2("battle cuiser", 5);
		...
		it("Test ship cell consumption - outside boundary", () => {
			const board = new Board2();
			const battleship = new Ship2("battle cuiser", 5);
			const startingPoint = new Cell2(0,6);
		...
		it("Test ship collistion - overlapping", () => {
			const board = new Board2();
			const ship1 = new Ship2("battle cuiser", 5);
			const ship1StartingPoint = new Cell2(0,0);
			...
			const ship2 = new Ship2("battle cuiser", 5);
			const ship2StartingPoint = new Cell2(0,1);
			const ship2BoardCells = ship2.getShipCellRangeOnBoard(board, ship2StartingPoint);

			// check collision
			expect(board.hasCollision(ship2BoardCells)).to.equal(true);

			// place ship with collision
			expect(() => board.occupyCellRange(ship2BoardCells)).to.throw("Collision detected.");
		});

		it("Test place ship in the board", () => {
			const board = new Board2();
			const ship = new Ship2("battle cuiser", 5);
			const startCell = new Cell2(0,0);
	...
	describe("Vertical Battleship", () => {
		...
		it("Test ship cell consumption - outside boundary", () => {
			const board = new Board2();
			const battleship = new Ship2("battle cuiser", 5, Direction.Vertical);
			const startingPoint = new Cell2(8,0);
		...
		it("Test ship collistion - overlapping", () => {
			const board = new Board2();
			const ship1 = new Ship2("battle cuiser", 5, Direction.Vertical);
			const ship1StartingPoint = new Cell2(0,0);
			const ship1BoardCells = ship1.getShipCellRangeOnBoard(board, ship1StartingPoint);
			...
			const ship2 = new Ship2("battle cuiser", 5, Direction.Vertical);
			const ship2StartingPoint = new Cell2(1,0);
			const ship2BoardCells = ship2.getShipCellRangeOnBoard(board, ship2StartingPoint);
		...
		it("Test place ship in the board", () => {
			const board = new Board2();
			const ship = new Ship2("battle cuiser", 5, Direction.Vertical);
			const startingPoint = new Cell2(0,0);
...
describe("Test Attack Ship", () => {
	...
	it("Attack horizontal battleship - HIT", () => {
		...
		const battleship = new Ship2("battle cuiser", 5);
		const startingPoint = new Cell2(0,0);
		const targetCell = new Cell2(0,1);
		const shipBoardCells = battleship.getShipCellRangeOnBoard(board, startingPoint);
	...
	it("Attack horizontal battleship - MISS", () => {
		...
		const startingPoint = new Cell2(0,0);
		const shipBoardCells = battleship.getShipCellRangeOnBoard(board, startingPoint);
		const targetCell = new Cell2(0,5);
		...
		expect(board.isCellState(targetCell, CellState.Miss)).to.equal(false);
	});
	...
	it("Attack vertical battleship - HIT", () => {
		...
		const battleship = new Ship2("battle cuiser", 5, Direction.Vertical);
		const startingPoint = new Cell2(0,0);
		const targetCell = new Cell2(1,0);
		const shipBoardCells = battleship.getShipCellRangeOnBoard(board, startingPoint);
	...
	it("Attack vertical battleship - MISS", () => {
		...
		const battleship = new Ship2("battle cuiser", 5, Direction.Vertical);
		const startingPoint = new Cell2(0,0);
		const targetCell = new Cell2(5,0);
		const shipBoardCells = battleship.getShipCellRangeOnBoard(board, startingPoint);
